...
<head>
    ...
    <title>Calculators:campus Book Mart</title>
    <style>
...
<body>
  ...
  <a href="javascript:void(0);" style="font-size:15px;" class="icon" onclick="myFunction()">&#9776;</a>
   ...
   <marquee>Your search for quality books and stationaries ends here..</marquee>
    ...
    <div class="oout">
        <h2><center>SCIENTIFIC CALCULATOR</center></h2>
        <form action="insertcart4.php" method="POST">
        <div class="iin">
            <img src="./images/scicasio.jpg">
            <h5><center>CASIO</center></h5>
            <p class="ii"><center>₹1000</center></p>
            <label for="qty">Quantity:</label><br/>
            <input type="number" min="1" max="100" id="qty" name="qty" value="1"><br/>
            <input type="hidden" name="name" value="Casio scientific calculator">
        ...
        <div class="iin">
            <img src="./images/scicanon.png">
            <h5><center>CANON</center></h5>
            <p class="ii"><center>₹1100</center></p>
            <label for="qty">Quantity:</label><br/>
            <input type="number" min="1" max="100" id="qty" name="qty" value="1"><br/>
            <input type="hidden" name="name" value="Canon scientific calculator">
        ...
        <div class="iin">
            <img src="./images/FC_994_M_1_2x-dfb37.jpg">
            <h5><center>FLAIR</center></h5>
            <p class="ii"><center>₹950</center></p>
            <label for="qty">Quantity:</label><br/>
            <input type="number" min="1" max="100" id="qty" name="qty" value="1"><br/>
            <input type="hidden" name="name" value="Flair  scientific calculator">
    ...
    <div class="out">
        <h2><center>BASIC CALCULATOR</center></h2>
        <form action="insertcart4.php" method="POST">
        <div class="in">
            <img src="./images/basiccasio.webp">
            <h5><center>CASIO</center></h5>
            <p class="ii"><center>₹200</center></p>
            <label for="qty">Quantity:</label><br/>
            <input type="number" min="1" max="100" id="qty" name="qty" value="1"><br/>
            <input type="hidden" name="name" value="Casio calculator">
        ...
        <div class="in">
            <img src="./images/basiccanon.webp">
            <h5><center>CANON</center></h5>
            <p class="ii"><center>₹300</center></p>
            <label for="qty">Quantity:</label><br/>
            <input type="number" min="1" max="100" id="qty" name="qty" value="1"><br/>
            <input type="hidden" name="name" value="Canon calculator">
        ...
        <div class="in">
            <img src="./images/basicflair.jpg">
            <h5><center>FLAIR</center></h5>
            <p class="ii"><center>₹200</center></p>
            <label for="qty">Quantity:</label><br/>
            <input type="number" min="1" max="100" id="qty" name="qty" value="1"><br/>
            <input type="hidden" name="name" value="Flair calculator">
            <input type="hidden" name="price" value="200">
            <p><button type="submit" class="btn" onclick="openPopup()">Add to cart</button>
              <div class="popup" id="popup">
                <h2>Item added! </h2>
