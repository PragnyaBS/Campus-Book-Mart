...
<head>
    ...
    <title>LongBooks:Campus Book Mart</title>
    <style>
...
<body>
  ...
  <a href="javascript:void(0);" style="font-size:15px;" class="icon" onclick="myFunction()">&#9776;</a>
   ...
   <marquee>Your search for quality books and stationaries ends here..</marquee>
    <h1><center>KINGSIZE BOOKS</center></h1><br>
    <div class="out">
    <form action="insertcart5.php" method="POST">
        <div class="in">
            <img src="./images/books.png">
            <h5><center>200 pages classmate book</center></h5>
            <p class="ii"><center>₹90</center></p>
            <label for="type">Book Type:</label><br/>
            <select id="type" name="type">
                <option value="1">Ruled</option>
                <option value="1">Unruled</option>
            </select><br/>
            <label for="qty">Quantity:</label><br/>
            <input type="number" min="1" max="100" id="qty" name="qty" value="1"><br/>
            <input type="hidden" name="name" value="Kingsize 200 pages classmate book">
        ...
        <div class="in">
            <img src="./images/books.png">
            <h5><center>100 pages classmate book</center></h5>
            ...
            <label for="qty">Quantity:</label><br/>
            <input type="number" min="1" max="100" id="qty" name="qty" value="1"><br/>
            <input type="hidden" name="name" value="Kingsize 100 pages classmate book">
        ...
        <div class="in">
            <img src="./images/books.png">
            <h5><center>Spiral classmate book</center></h5>
            ...
            <label for="qty">Quantity:</label><br/>
            <input type="number" min="1" max="100" id="qty" name="qty" value="1"><br/>
            <input type="hidden" name="name" value="Kingsize spiral classmate book">
