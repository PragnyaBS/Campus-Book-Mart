...
<body>
  ...
  <a href="javascript:void(0);" style="font-size:15px;" class="icon" onclick="myFunction()">&#9776;</a>
   ...
   <marquee>Your search for quality books and stationaries ends here..</marquee>
    <h1><center>LONG BOOKS</center></h1>
    <div class="out">
    <form action="insertcart1.php" method="POST">
        <div class="in">
            ...
            <input type="hidden" name="name" value="200 pages classmate book">
        ...
        <div class="in">
            ...
            <label for="qty">Quantity:</label><br/>
            <input type="number" min="1" max="100" id="qty" name="qty" value="1"><br/>
            <input type="hidden" name="name" value="100 pages classmate book">
        ...
        <div class="in">
            ...
            <label for="qty">Quantity:</label><br/>
            <input type="number" min="1" max="100" id="qty" name="qty" value="1"><br/>
            <input type="hidden" name="name" value="Spiral classmate book">
