...
<head>
    ...
    <title>ShortBooks:Campus Book Mart</title>
    <style>
   ...
   <marquee>Your search for quality books and stationaries ends here..</marquee>
    ...
    <form action="insertcart2.php" method="POST">
        <div class="in">
            ...
            <input type="hidden" name="name" value="Short 200 pages classmate book">
        ...
        <div class="in">
            ...
            <label for="qty">Quantity:</label><br/>
            <input type="number" min="1" max="100" id="qty" name="qty" value="1"><br/>
            <input type="hidden" name="name" value="Short 100 pages classmate book">
        ...
        <div class="in">
            ...
            <label for="qty">Quantity:</label><br/>
            <input type="number" min="1" max="100" id="qty" name="qty" value="1"><br/>
            <input type="hidden" name="name" value="Short spiral classmate book">
