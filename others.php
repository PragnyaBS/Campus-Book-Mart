...
<head>
    ...
    <title>Others:campus Book Mart</title>
    <style>
...
<body>
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content">
      ...
      <a href="./others.php" class="active">Others</a>
    </div>
  </div> 
  ...
  <a href="javascript:void(0);" style="font-size:15px;" class="icon" onclick="myFunction()">&#9776;</a>
   ...
   <marquee>Your search for quality books and stationaries ends here..</marquee>
    ...
    <form action="insertcart6.php" method="POST">
        ...
        <div class="in">
            <img src="./images/punching.webp">
            <h5><center>PUNCHING MACHINE</center></h5>
            <p class="ii"><center>₹300</center></p>
            <label for="qty">Quantity:</label><br/>
            <input type="number" min="1" max="100" id="qty" name="qty" value="1"><br/>
            <input type="hidden" name="name" value="Punching machine">
        ...
        <div class="in">
            <img src="./images/geometry.webp">
            <h5><center>GEOMETRY BOX</center></h5>
            <p class="ii"><center>₹150</center></p>
            <label for="qty">Quantity:</label><br/>
            <input type="number" min="1" max="100" id="qty" name="qty" value="1"><br/>
            <input type="hidden" name="name" value="Geometry box">
    ...
    <form action="insertcart6.php" method="POST">
        <div class="in">
            ...
            <h5><center>MARKERS(Pack of 10)</center></h5>
            <p class="ii"><center>₹100</center></p>
            <label for="qty">Quantity:</label><br/>
            <input type="number" min="1" max="100" id="qty" name="qty" value="1"><br/>
            <input type="hidden" name="name" value="Markers">
        ...
        <div class="in">
            ...
            <h5><center>HIGHLIGHTER</center></h5>
            <p class="ii"><center>₹150</center></p>
            <label for="qty">Quantity:</label><br/>
            <input type="number" min="1" max="100" id="qty" name="qty" value="1"><br/>
            <input type="hidden" name="name" value="Highlighter">
            <input type="hidden" name="price" value="150">
            <p> <button type="submit" class="btn" onclick="openPopup()">Add to cart</button>
              <div class="popup" id="popup">
                <h2>Item added! </h2>
        ...
        <div class="in">
            <img src="./images/paperclip.webp">
            <h5><center>PAPER CLIPS</center></h5>
            <p class="ii"><center>₹130</center></p>
            <label for="qty">Quantity:</label><br/>
            <input type="number" min="1" max="100" id="qty" name="qty" value="1"><br/>
            <input type="hidden" name="name" value="Paper clips">
    ...
    <form action="insertcart6.php" method="POST">
        <div class="in">
            ...
            <h5><center>STICKY NOTES(5mix colors eack of 80 sheets)</center></h5>
            <p class="ii"><center>₹50</center></p>
            <label for="qty">Quantity:</label><br/>
            <input type="number" min="1" max="100" id="qty" name="qty" value="1"><br/>
            <input type="hidden" name="name" value="Sticky notes">
        ...
        <div class="in">
            <img src="./images/eraser.jpg">
            <h5><center>ERASER</center></h5>
            <p class="ii"><center>₹10</center></p>
            <label for="qty">Quantity:</label><br/>
            <input type="number" min="1" max="100" id="qty" name="qty" value="1"><br/>
            <input type="hidden" name="name" value="Eraser">
        ...
        <div class="in">
            <img src="./images/sharpner.jpg">
            <h5><center>SHARPNER(PAck of 10)</center></h5>
            <p class="ii"><center>₹50</center></p>
            <label for="qty">Quantity:</label><br/>
            <input type="number" min="1" max="100" id="qty" name="qty" value="1"><br/>
            <input type="hidden" name="name" value="Sharpner">
            <input type="hidden" name="price" value="50">
            <p> <button type="submit" class="btn" onclick="openPopup()">Add to cart</button>
              <div class="popup" id="popup">
                <h2>Item added! </h2>
